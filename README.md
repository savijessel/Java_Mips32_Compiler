...
This project is a compiler written in C++ that converts a non-trivial subset of Java to Mips32. A copy of the Java Subset Specification (John Ayock, March 2022) is provided after a description of the dependicies and build and run instructions.
